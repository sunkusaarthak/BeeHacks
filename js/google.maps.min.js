...
!(function (e) {
    function t(t) {
        var r = {};
        return (
            (r.coords = e(t).attr("data-coords")),
            (r.address = e(t).attr("data-address")),
            (r.marker = e(t).attr("data-marker")),
            (r["marker-pos"] = e(t).attr("data-marker-pos")),
            (r["marker-pos-top"] = e(t).attr("data-marker-pos-top")),
            (r["marker-pos-left"] = e(t).attr("data-marker-pos-left")),
            (r.skin = e(t).attr("data-skin")),
            (r.zoom = e(t).attr("data-zoom")),
            isEmpty(r.zoom) && (r.zoom = 12),
            isEmpty(r["marker-pos-top"]) && (r["marker-pos-top"] = 0),
            isEmpty(r["marker-pos-left"]) && (r["marker-pos-left"] = 0),
            r
        );
    }
    function r(r) {
        ...
        var p = new google.maps.LatLng(i, y),
            n = { zoom: parseInt(a.zoom, 10), scrollwheel: !1, center: p };
        (s = new google.maps.Map(r.get(0), n)),
            isEmpty(a.skin) || s.setOptions({ styles: o[a.skin] });
        var f = { position: p, map: s };
        isEmpty(a.marker) || (f = { position: p, map: s, icon: a.marker });
        var m = (new google.maps.Marker(f), 0 - a["marker-pos-left"]),
            g = 0 - a["marker-pos-top"];
        if (!isEmpty(a["marker-pos"]) && e(window).width() > 993) {
            var T = a["marker-pos"];
            "col-md-6-right" == T
                ? (m -= (1 * e(".col-md-6").outerWidth()) / 2)
                : "col-md-6-left" == T
                    ? (m += e(".col-md-6").outerWidth() / 2)
                    : "center-bottom" == T
                        ? (g = g - (1 * e(r).outerHeight()) / 4 - 30)
                        : "center-top" == T && (g = g + e(r).outerHeight() / 2 - 60);
        }
    ...
    function l(l) {
        ...
        (o = new google.maps.Geocoder()),
            o.geocode({ address: s.address }, function (t, o) {
                o == google.maps.GeocoderStatus.OK &&
                    (e(l).attr(
                        "data-coords",
                        t[0].geometry.location.lat() + "," + t[0].geometry.location.lng()
                    ),
                        r(l));
            });
    }
    (e.fn.googleMap = function (o) {
        if ("initialized" != e(this).attr("data-trigger")) {
            var s = t(this);
            isEmpty(s.coords) ? l(this) : r(this),
                e(this).attr("data-trigger", "initialized");
        }
    }),
